...
(function (alert_1) {
    var Alert = (function (_super) {
        ...
        Alert.prototype.initView = function () {
            this._ui = fairygui.UIPackage.createObject("common", "alertSkin").asCom;
            this.addChild(this._ui);
            this._buttonNumController = this._ui.getController("buttonNum");
...
(function (tip) {
    ...
    var TipItem = (function (_super) {
        ...
        TipItem.prototype.initView = function () {
            this._ui = fairygui.UIPackage.createObject("common", "gameTipSkin").asCom;
    ...
    var TipManager = (function () {
        ...
        TipManager.prototype.showTextTip = function (message) {
            ...
            item.x = (gameTool.stage.stageWidth - item.width) / 2 - 165;
